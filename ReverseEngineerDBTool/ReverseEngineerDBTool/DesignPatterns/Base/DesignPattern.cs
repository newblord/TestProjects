...
using ReverseEngineerDBTool.DesignPatterns.Models;
using System;
using System.Text;
...
namespace ReverseEngineerDBTool.DesignPatterns
{
    public abstract class DesignPattern
    {
        ...
        public static void ProcessDatabaseXML()
        {
            ...
            var solutionFilePath = Path.GetDirectoryName(Path.GetDirectoryName(Path.GetDirectoryName(Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location))));
        ...
        public void ProcessFiles()
        {
            ...
            if (NewFiles.Any())
            {
                ...
                {
                    Project p = VisualStudioHelper.FindProject(groupedFiles[x].ProjectName);
                    ...
                    var outputPath = Path.Combine(path, groupedFiles[x].FolderName);
