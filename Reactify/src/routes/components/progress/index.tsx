               ...
               >
                  <div className={classes.root}>
                     <div className={classes.wrapper}>
                        <Fab variant="round" size="large" color="secondary" className={buttonClassname}
                     ...
                     <div className={classes.wrapper}>
                        <Button variant="contained" color="secondary" className={buttonClassname} disabled={loading} onClick={this.handleButtonClick} >
                           Accept terms
