...
namespace DatabaseGenerationToolExt.DesignPatterns
{
	...
	{
		public EntityFrameworkDesignPattern(string targetFrameworkVersion, DatabaseGenerationSetting setting, Package package, List<TableData> tableNames, List<string> storedProcNames) 
			: base(targetFrameworkVersion, setting, package, tableNames, storedProcNames)
		{
		}
		...
		public void CreateFiles(Tables tables, List<StoredProcedure> storedProcedures)
		{
