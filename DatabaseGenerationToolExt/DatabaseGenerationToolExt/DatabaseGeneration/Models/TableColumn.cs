...
namespace DatabaseGenerationToolExt.DatabaseGeneration.Models
{
    public class TableColumn : Base.Column
    {
        ...
        public string EnumEntity { get; set; }
        ...
        private void SetupEntity(CommentsStyle includeComments)
        {
            ...
            if (string.IsNullOrEmpty(EnumDataTypeName))
            {
                ...
                EnumEntity = string.Empty;
            }
            else
            {
                Entity = string.Empty;
                InterfaceEntity = string.Format("{0} {1} {{ get; set; }}{2}", EnumDataTypeName, NameHumanCase, inlineComments);
                EnumEntity = string.Format("public {0} {1} {{ get; set; }}{2}", EnumDataTypeName, NameHumanCase, inlineComments);
            }
        }
