...
namespace EF6EdmxData
{
    ...
    public partial class Xlpc
    {
        ...
        public Nullable<System.DateTime> SCORING_START_DATE { get; set; }
        ...
        public Nullable<int> DEPOSIT_METHOD_AUTO_PAY_CALC_ORDER_RULE_DEF_SET_KEY { get; set; }
        ...
        public Nullable<int> LOAN_PRODUCT_CONFIG_OPEN_END_KEY { get; set; }
        public Nullable<decimal> ACTIVITY_FEE_AMT { get; set; }
        public Nullable<decimal> ACTIVITY_FEE_PCT { get; set; }
        public Nullable<byte> CAB_DEFAULT_LOAN_LENGTH { get; set; }
        public Nullable<byte> CAB_FEE_DAY_OFFSET { get; set; }
        public Nullable<bool> CASH_ADVANCE_DISABLED { get; set; }
        public Nullable<decimal> CASH_ADVANCE_LIMIT_AMT { get; set; }
        public Nullable<bool> CASH_ADVANCE_LIMIT_ENABLED { get; set; }
        public Nullable<short> CLOSE_WHEN_INACTIVE_DAYS { get; set; }
        public Nullable<bool> CLOSE_WHEN_PAID_OFF { get; set; }
        public Nullable<byte> COOLING_DAYS_AFTER_FINAL_ROLLOVER { get; set; }
        public Nullable<byte> COOLING_DAYS_CASH_ADVANCE_AFTER_PAYMENT { get; set; }
        public Nullable<byte> CYCLE_DAYS { get; set; }
        public Nullable<bool> FLAT_FEE_BIWEEKLY_RATES_ENABLED { get; set; }
        public Nullable<bool> FLAT_FEE_RULES_ENABLED { get; set; }
        public Nullable<bool> GIFT_CARD_PROCEEDS_ENABLED { get; set; }
        public Nullable<System.DateTime> ENFORCE_ROLLOVER_RESTRICTIONS_AS_OF_DATE { get; set; }
        public Nullable<bool> IS_ORDINANCE_LOCATION { get; set; }
        public Nullable<bool> LIMIT_ZERO_BALANCE_STATEMENTS { get; set; }
        public Nullable<decimal> MIN_PRINC_DUE_FOUR_WEEKS_AMT { get; set; }
        public Nullable<decimal> MIN_PRINC_DUE_FOUR_WEEKS_PCT { get; set; }
        public Nullable<decimal> MIN_PRINC_DUE_TWO_WEEKS_AMT { get; set; }
        public Nullable<decimal> MIN_PRINC_DUE_TWO_WEEKS_PCT { get; set; }
        public Nullable<byte> NEW_LOAN_WITHIN_CLOSING_PREVIOUS_LOAN_DAYS { get; set; }
        public Nullable<bool> NEW_LOAN_WITHIN_CLOSING_PREVIOUS_LOAN_ONLY_ENABLED { get; set; }
        public Nullable<short> NON_ORDINANCE_LOCATION { get; set; }
        public Nullable<bool> PAY_PRINC_BEFORE_NEXT_AND_NOT_DUE { get; set; }
        public Nullable<byte> PAYMENT_DUE_CYCLE_DAYS { get; set; }
        public Nullable<bool> PRINC_AMT_INCREMENT_ENABLED { get; set; }
        public Nullable<decimal> PRINC_AMT_INCREMENT_AMT { get; set; }
        public Nullable<bool> STMTS_EMAIL_ENABLED { get; set; }
        public Nullable<short> STMTS_GEN_CYCLE_DAYS { get; set; }
        public string XLPCT { get; set; }
        public Nullable<int> LOAN_PRODUCT_CONFIG_TITLE_KEY { get; set; }
        public Nullable<decimal> APPROVAL_PCT_EMPLOYED_24_PLUS_MONTHS { get; set; }
        public Nullable<decimal> APPROVAL_PCT_EMPLOYED_6_TO_23_MONTHS { get; set; }
        public Nullable<decimal> APPROVAL_PCT_EMPLOYED_UP_TO_5_MONTHS { get; set; }
        public Nullable<decimal> APPROVAL_PCT_WHOLESALE_GREATER_THAN_1500_CHECKING_ACCT { get; set; }
        public Nullable<decimal> APPROVAL_PCT_WHOLESALE_GREATER_THAN_1500_CHECKING_ACCT_DIRECT_DEPOSIT { get; set; }
        public Nullable<decimal> APPROVAL_PCT_WHOLESALE_GREATER_THAN_1500_DEBIT_CARD { get; set; }
        public Nullable<decimal> APPROVAL_PCT_WHOLESALE_UP_TO_1500_CHECKING_ACCT { get; set; }
        public Nullable<decimal> APPROVAL_PCT_WHOLESALE_UP_TO_1500_CHECKING_ACCT_DIRECT_DEPOSIT { get; set; }
        public Nullable<decimal> APPROVAL_PCT_WHOLESALE_UP_TO_1500_DEBIT_CARD { get; set; }
        public Nullable<short> LEGAL_MAX_LOAN_VEHICLE_VALUE_PCT { get; set; }
        public string LEGAL_MAX_LOAN_VEHICLE_VALUE_WHOLESALE_OR_RETAIL { get; set; }
        public Nullable<decimal> LIEN_FEE_AMT { get; set; }
        public Nullable<bool> LIEN_FEE_FINANCED_ENABLED { get; set; }
        public Nullable<int> LOAN_AMT_MGR_OVERRIDE_VEHICLE_VALUE_PCT { get; set; }
        public string LOAN_AMT_MGR_OVERRIDE_VEHICLE_WHOLESALE_OR_RETAIL { get; set; }
        public Nullable<decimal> LOAN_AMT_NO_INSURANCE_MAX_AMT { get; set; }
        public Nullable<bool> MAX_LOAN_VEHICLE_VALUE_PCT_ENABLED { get; set; }
        public Nullable<bool> MULT_LOANS_VIN_ENABLED { get; set; }
        public Nullable<decimal> ORIG_FEE_PCT_2ND_LIEN { get; set; }
        public Nullable<decimal> REPO_ASSIGNMENT_MIN_BALANCE { get; set; }
        public Nullable<bool> REQUIRE_COPLEDGE_DETAILS { get; set; }
        public Nullable<bool> REQUIRE_COPLEDGE_EYE_COLOR { get; set; }
        public Nullable<bool> REQUIRE_COPLEDGE_GENDER { get; set; }
        public Nullable<bool> REQUIRE_COPLEDGE_HAIR_COLOR { get; set; }
        public Nullable<bool> REQUIRE_COPLEDGE_HEIGHT { get; set; }
        public Nullable<bool> REQUIRE_COPLEDGE_RACE { get; set; }
        public Nullable<bool> REQUIRE_COPLEDGE_SSN { get; set; }
        public Nullable<bool> REQUIRE_DETAILS { get; set; }
        public Nullable<bool> REQUIRE_EYE_COLOR { get; set; }
        public Nullable<bool> REQUIRE_GENDER { get; set; }
        public Nullable<bool> REQUIRE_HAIR_COLOR { get; set; }
        public Nullable<bool> REQUIRE_HEIGHT { get; set; }
        public Nullable<bool> REQUIRE_RACE { get; set; }
        public Nullable<bool> USE_FUEL_TYPE { get; set; }
        public Nullable<bool> USE_LEGAL_STATUS { get; set; }
        public Nullable<bool> USE_LIEN_HOLDER { get; set; }
        public Nullable<bool> USE_ODO_CODE { get; set; }
        public Nullable<bool> USE_REGISTRATION_DATE { get; set; }
        public Nullable<bool> USE_REGISTRATION_EXPIRES { get; set; }
        public Nullable<bool> USE_STATE_NUM { get; set; }
        ...
        public Nullable<byte> MAX_LOAN_VEHICLE_VALUE_PCT { get; set; }
